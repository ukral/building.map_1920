...
BSM_1920 <- st_read(paste(dir_zenodo, "Datasets/Building stock and age 1920/BSM_1920.shp", sep = ""), quiet = T)

# Import dataset
dataset_final <- read.csv(paste(dir_zenodo, "Datasets/Building stock and age 1920/BSM_1920_attribute_table_final.csv", sep = ""), sep = ";")

# Import SHP file "City boundary 2020"
CB_2020 <- st_read(paste(dir_zenodo, "Background data/City boundary 2020/CB_2020.shp", sep = ""), quiet = T)

# Import SHP file "Areas out of scope 1920"
AOOS_1920 <- st_read(paste(dir_zenodo, "Background data/Areas out of scope 1920/AOOS_1920.shp", sep = ""), quiet = T)
...
DD_T_10 <- read_xlsx(paste(dir_zenodo, "Background data/Tables.xlsx", sep = ""), sheet = "DD_T_10", col_names =  TRUE, range = "A3:C31")

CB_CB_1920_AT <- read_xlsx(paste(dir_zenodo, "Background data/Tables.xlsx", sep = ""), sheet = "CB_CB_1920_AT", col_names =  TRUE, range = "A3:B5")

CB_UDB_1920_AT <- read_xlsx(paste(dir_zenodo, "Background data/Tables.xlsx", sep = ""), sheet = "CB_UDB_1920_AT", col_names =  TRUE, range = "A3:B6")

CB_SABAM_1920_AT <- read_xlsx(paste(dir_zenodo, "Background data/Tables.xlsx", sep = ""), sheet = "CB_SABAM_1920_AT", col_names =  TRUE, range = "A3:B5")
...
knitr::include_graphics(here::here(paste(dir_github, "/Figures/Codebook_figure_FF.png", sep = "")))
```
