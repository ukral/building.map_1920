...
# Preface {-}
This usage code is currently under double-blind peer-review. Once the corresponding manuscript becomes accepted for publishing, we add the author names and affiliation to this dataset, the grant information as well as the link to the corresponding article. We encourage users to wait until the review process has been completed.
...
* **supplements** the aforementioned paper and enables the reproduction of figures and data. 
...
figure_out_6 <- ggarrange(area_district_adapt_plot, bp_plot, align = "v", ncol = columns, nrow = rows, labels = "auto")

ggsave(paste(dir_output, "Figure 06.png", sep = ""), plot = figure_out_6, width = 9 , height = 8)

ggsave(paste(dir_output, "Figure 06.pdf", sep = ""), plot = figure_out_6, width = 9 , height = 10)
...
figure_out_7 <- ggarrange(plaus_dist_area_plot, building_counts, align = "v", ncol = columns, nrow = rows, labels = "auto")

ggsave(paste(dir_output, "Figure 07.png", sep = ""), plot = figure_out_7, width = 9 , height = 8)

ggsave(paste(dir_output, "Figure 07.pdf", sep = ""), plot = figure_out_7, width = 9 , height = 8)
...
figure_out_8 <- ggarrange(location_confirm_plot, temp_presence_district_plot, location_overview_analysis_plot, align = "v", ncol = columns, nrow = rows, labels = "auto")
ggsave(paste(dir_output, "Figure 08.png", sep = ""), plot = figure_out_8, width = columns * 9 , height = rows*4)
ggsave(paste(dir_output, "Figure 08.pdf", sep = ""), plot = figure_out_8, width = columns * 9 , height = rows*4)
...
figure_09 <- ggarrange(BSM_1920_bc_final_plot, Ratio_CD.bs_data_plot, CD.bs_fit_source_plot, CD.bs_fit_data_plot, align = "v", ncol = columns, nrow = rows, labels = "auto")

ggsave(paste(dir_output, "Figure 09.png", sep = ""), plot = figure_09, width = columns *9 , height = rows* 4)
ggsave(paste(dir_output, "Figure 09.pdf", sep = ""), plot = figure_09, width = columns * 9 , height = rows* 4)
...
# ggsave(paste(dir_output, "Figure 06.png", sep = ""), plot = figure_out_1, width = columns * 9 , height = rows*4)
# ggsave(paste(dir_output, "Figure 06.pdf", sep = ""), plot = figure_out_1, width = columns * 9 , height = rows*4)
# 
# 
# # Plot figure 07
# columns = 1
...
# ggsave(paste(dir_output, "Figure 07.png", sep = ""), plot = figure_out_2, width = columns * 9 , height = rows*4)
# ggsave(paste(dir_output, "Figure 07.pdf", sep = ""), plot = figure_out_2, width = columns * 9 , height = rows*4)
# 
# 
# 
# 
...
# ggsave(paste(dir_output, "Figure 09.png", sep = ""), plot = figure_loc, width = columns * 9 , height = rows*4)
# 
# ggsave(paste(dir_output, "Figure 09.pdf", sep = ""), plot = figure_loc, width = columns * 9 , height = rows*4)
# 
# 
