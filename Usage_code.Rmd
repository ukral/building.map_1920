...
dir_output = "C:/Users/u.kral/ownCloud/03_TU Wien/building.map_1920/03_Output/"
######################################################################################
...
wien1920 <- read.table(paste(dir_zenodo, "Building stock and age 1920/BSM_1920_attribute_table_temporary.csv", sep = ""), sep = ";", stringsAsFactors = F)
...
pdf(paste(dir_output, "Figure 01a.pdf", sep = ""), width = 600/60, height = 350/60)
par(mar=c(5,5,3,5))
...
pdf(paste(dir_output, "Figure 01b.pdf", sep = ""), width = 600/60, height = 350/60)
par(mar=c(5,5,3,5))
...
pdf(paste(dir_output, "Test2.pdf", sep = ""), width = 10, height = 13)
...
write.table(wien1920[,DD_OOT_2$Data_field], file = paste(dir_output, "BSM_1920_attribute_table_final.csv", sep = ""), sep = ";", row.names=FALSE)
...
ggsave(paste(dir_output, "Figure 07.png", sep = ""), plot = figure_out_1, width = columns * 9 , height = rows*4)
ggsave(paste(dir_output, "Figure 07.pdf", sep = ""), plot = figure_out_1, width = columns * 9 , height = rows*4)
...
ggsave(paste(dir_output, "Figure 08.png", sep = ""), plot = figure_out_2, width = columns * 9 , height = rows*4)
ggsave(paste(dir_output, "Figure 08.pdf", sep = ""), plot = figure_out_2, width = columns * 9 , height = rows*4)

# Plot Figure 09

ggsave(paste(dir_output, "Figure 09.png", sep = ""), plot = plaus_dist_area_plot, width = 9 , height = 4)

ggsave(paste(dir_output, "Figure 09.pdf", sep = ""), plot = plaus_dist_area_plot, width = 9 , height = 4)

# Plot Figure 10
ggsave(paste(dir_output, "Figure 10.png", sep = ""), plot = p, width = 9 , height = 5)
ggsave(paste(dir_output, "Figure 10.pdf", sep = ""), plot = p, width = 9 , height = 5)
...
ggsave(paste(dir_output, "Figure 11.png", sep = ""), plot = figure_loc, width = columns * 9 , height = rows*4)

ggsave(paste(dir_output, "Figure 11.pdf", sep = ""), plot = figure_loc, width = columns * 9 , height = rows*4)
...
ggsave(paste(dir_output, "Figure 12.png", sep = ""), plot = figure_12, width = columns *9 , height = rows* 4)
ggsave(paste(dir_output, "Figure 12.pdf", sep = ""), plot = figure_12, width = columns * 9 , height = rows* 4)
