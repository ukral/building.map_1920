...
ggsave(paste(dir_output, "Figure 08.png", sep = ""), plot = figure_out_1, width = columns * 9 , height = rows*4)
ggsave(paste(dir_output, "Figure 08.pdf", sep = ""), plot = figure_out_1, width = columns * 9 , height = rows*4)
...
ggsave(paste(dir_output, "Figure 09.png", sep = ""), plot = figure_out_2, width = columns * 9 , height = rows*4)
ggsave(paste(dir_output, "Figure 09.pdf", sep = ""), plot = figure_out_2, width = columns * 9 , height = rows*4)

# Plot Figure 10

ggsave(paste(dir_output, "Figure 10.png", sep = ""), plot = plaus_dist_area_plot, width = 9 , height = 4)

ggsave(paste(dir_output, "Figure 10.pdf", sep = ""), plot = plaus_dist_area_plot, width = 9 , height = 4)

# Plot Figure 11
ggsave(paste(dir_output, "Figure 11.png", sep = ""), plot = p, width = 9 , height = 5)
ggsave(paste(dir_output, "Figure 11.pdf", sep = ""), plot = p, width = 9 , height = 5)
...
ggsave(paste(dir_output, "Figure 12.png", sep = ""), plot = figure_loc, width = columns * 9 , height = rows*4)

ggsave(paste(dir_output, "Figure 12.pdf", sep = ""), plot = figure_loc, width = columns * 9 , height = rows*4)
...
ggsave(paste(dir_output, "Figure 13.png", sep = ""), plot = figure_12, width = columns *9 , height = rows* 4)
ggsave(paste(dir_output, "Figure 13.pdf", sep = ""), plot = figure_12, width = columns * 9 , height = rows* 4)
