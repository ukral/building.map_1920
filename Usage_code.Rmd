...
# Preface {-}
This usage code corresponds with a Data Descriptor, which is currently under review at [Nature Scientific Data](https://www.nature.com/sdata/). Once the Data Descriptor is accepted for publishing, the corresponding datasets will be accessible and can be used and re-used.
...
* **supplements** the aforementioned Data Descriptor and enables the reproduction of figures and data. 
...
DD_OOT_2 <- read_xlsx(paste(dir_github, "Background_data.xlsx", sep = ""), sheet = "DD_OOT_2", col_names =  TRUE, range = "A3:C31")
...
UD_AREA_1920_statistic <- read_xlsx(paste(dir_github, "Background_data.xlsx", sep = ""), sheet = "UD_AREA_1920_statistic", col_names =  TRUE, range = "A3:B24")
...
####### Plot 1
plot(data[,1], data[,3], type = "p", pch = 19, xlab="", ylab = "", cex=1.5,las=1, xlim = c(1700,2050), ylim = c(0,200000)) # Häuser
title(main = "Building counts and settlement areas for the city of Vienna", adj = 0)
par(new=T)
plot(data[,1], data[,4]*100, col=2, pch = 19, ylab="", xlab="year",cex=1.5,  xlim = c(1700,2050), xaxt="n", yaxt="n", ylim = c(0,20000)) # Siedlungsfläche in ha
...
####### Plot 2
par(mar=c(5,5,2,5))
dummy_data <- data.frame(seq(1700, 2050, by = 50), seq(0, 130, by = 130/7))
...
text(1938, ok+ab+ab + 5, "Aerial photographs", col = "black", pos = 4, font = fn)

# Building stock maps
uk <- 60 # unterkante vom senkrechten balken
text(1829, uk+hoehe + 5, "Historic building stock maps", col="black", pos = 4, font = fn)

#1920 Stadkarte
rect(1920, uk, 1921, uk+hoehe, col = mycol2, border = mycol2)
text(1921, uk + 5, "Building stock\nmap 1920", col = "darkblue", pos = 4)
...
text(1829, uk + 5, "Franzeisischer\nKataster 1829", col = "darkblue", pos = 4)

ab <- ab*1.5

# Setttlemen Area maps

text(1704, uk+ab+hoehe + 5, "Historic settlement area maps", col="black", pos = 4, font = fn)

rect(1912, uk+ab, 1913, uk+ab+hoehe, col = mycol2, border = mycol2)
text(1912-2, uk+ab + 2, "1912", col = "darkblue", pos = 4)

rect(1875, uk+ab, 1876, uk+ab+hoehe, col = mycol2, border = mycol2)
text(1875-2, uk+ab + 2, "1875", col = "darkblue", pos = 4)

rect(1825, uk+ab, 1826, uk+ab+hoehe, col = mycol2, border = mycol2)
text(1825-2, uk+ab + 2, "1825", col = "darkblue", pos = 4)

rect(1780, uk+ab, 1781, uk+ab+hoehe, col = mycol2, border = mycol2)
text(1780-2, uk+ab + 2, "1780", col = "darkblue", pos = 4)

rect(1755, uk+ab, 1756, uk+ab+hoehe, col = mycol2, border = mycol2)
text(1755-2, uk+ab + 2, "1755", col = "darkblue", pos = 4)

rect(1704, uk+ab, 1705, uk+ab+hoehe, col = mycol2, border = mycol2)
text(1704-2, uk+ab + 2, "1704", col = "darkblue", pos = 4)

# Hintergrundblöcke
rect(1700, 0, 2050, 50, col = mycol3, border = mycol3)
text(1700, 50-5, "Topographic documents", col = "grey25", pos = 4, font = 2)

rect(1700, 55, 2050, 115, col = mycol3, border = mycol3)
text(1700, 110, "Reconstruction and mapping of historical settlement data", col = "grey25", pos = 4, font = 2)
...
ggsave(paste(dir_output, "Figure 01.png", sep = ""), plot = Figure_1(), width = columns * 9 , height = rows*5)
ggsave(paste(dir_output, "Figure 01.pdf", sep = ""), plot = Figure_1(), width = columns * 9 , height = rows*5)
