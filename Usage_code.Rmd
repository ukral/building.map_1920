...
figure_out_3 <- ggarrange(plaus_dist_area_plot, building_counts, align = "v", ncol = columns, nrow = rows, labels = "auto")

ggsave(paste(dir_output, "Figure 08.png", sep = ""), plot = figure_out_3, width = 9 , height = 4)

ggsave(paste(dir_output, "Figure 08.pdf", sep = ""), plot = figure_out_3, width = 9 , height = 4)
...
figure_10 <- ggarrange(BSM_1920_bc_final_plot, Ratio_CD.bs_data_plot, CD.bs_fit_source_plot, CD.bs_fit_data_plot, align = "v", ncol = columns, nrow = rows, labels = "auto")

ggsave(paste(dir_output, "Figure 10.png", sep = ""), plot = figure_10, width = columns *9 , height = rows* 4)
ggsave(paste(dir_output, "Figure 10.pdf", sep = ""), plot = figure_10, width = columns * 9 , height = rows* 4)
